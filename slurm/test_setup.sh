#!/bin/bash
#SBATCH --job-name=benjamin_test       # Job name
...
# Description: This script tests the environment by running the setup_test.py script. It should be submitted via SLURM.
